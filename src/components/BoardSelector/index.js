...
export const boardOptions = [
  { value: 'Betű körül (ingyenes)', label: 'Betű körül (ingyenes)', price: 0, index: 0, },
  { value: 'Téglalap alakú (ingyenes)', label: 'Téglalap alakú (ingyenes)', price: 0, index: 1, },
  { value: 'Felirat körül közvetlenül (+13.000 Ft)', label: 'Felirat körül közvetlenül (+13.000 Ft)', price: 13000, index: 2 },
...
const BoardSelector = () => {
  ...
  const boardOptionsEn = [
    { value: 'Cut to text (free)', label: 'Cut to text (free)', price: 0, index: 0 },
    { value: 'Rectangle (free)', label: 'Rectangle (free)', price: 0, index: 1 },
    { value: `Cut to shape (+${formatSum(13000)})`, label: `Cut to shape (+${formatSum(13000)})`, price: 13000, index: 2, },
